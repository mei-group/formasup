...
# ==========================================
    ...
    <div style="background-color: #F8FAFC; border: 1px solid #E2E8F0; padding: 30px; border-radius: 12px; text-align: center;">
        ...
        <a href="https://bookings.cloud.microsoft/bookwithme/user/bd5349eb51c445a5b9ff4bb69132d3c1%40formasup-odyssee.fr?anonymous&ismsaljsauthenabled" target="_blank" style="background-color: #0077B6; color: white; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; display: inline-block;">Prendre rendez-vous avec un conseiller</a>
    </div>
    """, unsafe_allow_html=True)
